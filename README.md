...
> **Tiền tệ:** Website phiên bản Mỹ sử dụng USD; giá tiền được lưu dưới dạng cent trong database (ví dụ 690 = $6.90).
...
- Monitoring endpoint: `/healthz` (returns only OK/503).
...
## V2.7.2
Admin AJAX CSRF hardening and a functional Admin Audit Log viewer are included.
